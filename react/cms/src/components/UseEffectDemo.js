...
function UseEffectDemo() {
  ...
  // }, []); //[] is dependency array ; empty means all.;
  ...
  return (
    <>
      ...
      <button onClick={() => setEmotion("Sick")} >
        Make Sick </button>
      <button onClick={() => setEmotion("Enthustiastic")} >
        Make Enthuse</button>
      <button onClick={() => setEmotion("Amazed")} >
        Make Amaze</button><br />
      <button onClick={() => setSecondary("Crabby")} >
        Make Crabby </button>
      <button onClick={() => setSecondary("Happy")} >
        Make Happy</button>
      <button onClick={() => setSecondary("Drowsy")} >
        Make Drowsy</button>
      <hr />
      <input id="cheked" type="checkbox" value={checked}
        onChange={toggle} />
      <p>
