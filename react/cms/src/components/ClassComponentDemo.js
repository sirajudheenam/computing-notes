  ...
  render() {
    return (
      <div>
        ...
        <button onClick={() => this.changeColor("Orange")} className='btn btn-primary'>Change Color</button>
        <p />
        <label htmlFor="style">Style:</label>
        <input id="style" type="text"></input>
        <button onClick={() => this.changeColor("Heroic")} className='btn btn-secondary'>Change Style</button>
      </div>
    );
  }
}
